...
class IonAuth extends \IonAuth\Config\IonAuth
{
	 ...
	 */
	public $siteTitle                = 'Audit Survey';       // Site Title, example.com
	public $adminEmail               = '4testurposeonly@gmail.com'; // Admin Email, admin@example.com
	public $defaultGroup             = 'Onsite Audit Staff';           // Default group, use name
	public $adminGroup               = 'Super Admin';             // Default administrators group, use name
	 ...
	 * @var string
	 */
	public $emailTemplates = 'Modules\Auth\Views/email/';
	...
	public $templates = [
		...
		'errors'   => [
			'list' => 'Modules\Auth\Views\message_list',
		],

		// templates for messages
		'messages' => [
			'list'   => 'Modules\Auth\Views\message_list',
			'single' => 'IonAuth\Auth\Views\message_single',
		],
	];
}
