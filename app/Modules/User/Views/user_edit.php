...
<!-- Content Wrapper. Contains page content -->
 <!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper">
    ...
    <?php echo form_open(base_url('users/edit/'.service('request')->uri->getSegment(3)), ['class' => 'userForm']); ?>
        ...
        <div class="card form-box">
            ...
            <div class="card-body">
                ...
                <div class="card-footer">
                    <?php echo form_submit('submit', 'Update User', ['class' => 'btn btn-warning float-right ']); ?>
                </div>
            </div>
            <!-- /.card-body -->
          </div>
