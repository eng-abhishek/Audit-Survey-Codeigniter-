...
<div class="content-wrapper">
      ...
      <section class="content-header">
            <div class="container-fluid">
                  <div class="row mb-2">
                        <div class="col-sm-6">
                              <h1>Edit Bus Company</h1>
                        </div>
                        <div class="col-sm-6">
                              <ol class="breadcrumb float-sm-right">
                                    <li class="breadcrumb-item"><a href="<?php echo base_url(); ?>">Home</a></li>
                                    <li class="breadcrumb-item"><a href="<?php echo base_url('bus-companies'); ?>">Bus Companies</a></li>
      ...
      <section class="content">
            <div class="container-fluid">
                  <?php echo form_open(base_url('bus-companies/edit/' . service('request')->uri->getSegment(3)), ['class' => 'buscompany']); ?>
                                          ...
                                          <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                ...
                                                $name = [
                                                    ...
                                                    'id'    => 'name',
                                                    'class'  => 'form-control',
                                                    'value' => set_value('name', $record->company_name ?: ''),
                                                    'required' => TRUE,
                                                    'maxlength' => '150',
                                                ];
                                       ...
                                       <!-- <div class="form-group row">
                                            ...
                                            <div class="input-group col-sm-9">
                                              <?php
                                                ...
                                                ?>
                                                 <input id='is_active' type='hidden' value='<?php echo $record->is_active; ?>' name='is_active'>  
                                            </div>
                                        </div> -->
                                        <div class="form-group row">
                                            <div class="col-sm-3">
                                            ...
                                            <div class="col-sm-9">
                                                <?php
                                                  $mobile = [
                                                    ...
                                                    'id'    => 'mobile',
                                                    'class'  => 'form-control',
                                                    'value' => set_value('mobile', $record->phone ?: ''),
                                                    'type' => 'text',
                                                    'required' => TRUE,
                                                    'maxlength' => '20',
                                                ];
                                            ...
                                            <div class="col-sm-9">
                                                <?php
                                                  $contractor_code = [
                                                    ...
                                                    'id'    => 'contractor_code',
                                                    'class'  => 'form-control',
                                                    'value' => set_value('contractor_code', $record->contractor_code ?: ''),
                                                    'type' => 'text',
                                                    'required' => TRUE,
                                                    'maxlength' => '100',
                                                ];
