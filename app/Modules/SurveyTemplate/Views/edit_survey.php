    ...
    <section class="content">
      <div class="container-fluid">
        <div class="card form-box">
            <!-- /.card-header -->
            <div class="card-body">
               <?php echo form_open(base_url('surveytemplate/edit/'.$template_id), ['class' => 'editsurveytemplateform','id' => 'add_survey_form']); ?>
                  <div class="row">
                    <div class="col-sm-6">
                    ...
                    <div class="col-sm-3">
                        <div class="form-group">
                            <?php
                                ...
                                if($status == 1)
                                {
                                    $dstatus_checked = 'checked';
                                }
                            ?>
                            <div class="button-switch float-left">
                                <input type="checkbox" name="template_status" value="<?php echo $status; ?>" id="template_status" class="switch" <?php echo $dstatus_checked; ?> />
                  ...
                  <div class="card-footer">
                        <button type="submit" class="btn btn-warning float-right"><?php echo lang('SurveyTemplate.update_field_button') ?></button>
                  </div>
              <?php echo form_close(); ?>
