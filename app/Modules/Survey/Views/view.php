      ...
      <div class="container-fluid">
        <div class="card form-box">
            <div class="card-header">
              <h3 class="card-title">View Surveys</h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
                  <div class="row">
                        		...
                        		<table class="table table-light">
								  <thead>
								    <tr>
								      ...
								      <th scope="col">School Destination</th>
								      <th scope="col">Bus Company</th>
								      <th scope="col">Count of Surveys</th>
								      <th scope="col">Count of Surveys with alert flags</th>
								    </tr>
								  </thead>
								  <tbody>
								  	<?php 
								  		foreach($survey_table_data as $key => $value)
								  		{
								  			echo "<tr>";
                  ...
                  <div class="card-footer">
                  		<a href="<?php echo base_url('survey'); ?>" class="btn btn-warning float-right" >Close</a>
                       <a href="<?php echo base_url('survey'); ?>" class="btn btn-info float-right" style="background-color: #402e2a;">View Response</a>
                  </div>
            </div>
            <!-- /.card-body -->
          </div>
